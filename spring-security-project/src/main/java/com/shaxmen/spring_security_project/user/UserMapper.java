...
public interface UserMapper {
  ...
  @Mapping(target = "enabled", constant = "true") // This is a default version of the user if you wanna do some verifying before it you should set it to false (Phone verifying or Email one)
